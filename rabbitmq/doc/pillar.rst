...
IP/Hostname in LAN of :doc:`/rabbitmq/doc/index` node.
...
IP/Hostname reachable from Internet of :doc:`/rabbitmq/doc/index` node.
...
Never use ``guest`` as it's a default :doc:`/rabbitmq/doc/index` user that is removed for security
reasons.
...
List of hostnames that :doc:`/rabbitmq/doc/index` management console is reachable.
...
Dict of {'vhostname': 'password'} of all :doc:`/rabbitmq/doc/index` virtual hosts.
