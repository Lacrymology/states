...
The initial application of this formula will take a while as it :doc:`/rsync/doc/index` the entire
content of :ref:`pillar-salt_archive-source` :doc:`/rsync/doc/index` server.
