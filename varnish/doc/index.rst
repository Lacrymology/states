...
`Squid <https://en.wikipedia.org/wiki/Squid_(software)>`_, which began life as a
client-side cache, or `Apache
<https://en.wikipedia.org/wiki/Apache_HTTP_server>`_ and
:doc:`/nginx/doc/index`, which are primarily origin servers, Varnish was
